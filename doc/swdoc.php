...
$fctAuth = array(); //toutes les fonctions sont autorisées à se connecter
...
if($_SERVER['REMOTE_ADDR'] != '127.0.0.1' &&		//Localhost
   ...
   $_SERVER['REMOTE_ADDR'] != '146.185.40.1'      	//Oxalide
	...
	$server->register('authentifierAdherent',
		...
		'urn:sgdfwsdl#authentifierAdherent',    // soapaction
		'rpc',                               	// style
		'encoded',                           	// use
		'Services Web SGDF'
	);
...
//retiré le 12/11/2014 - ne fonctionnait pas avec les mots de passe avec un espace
//      $mdp = urldecode($mdp);
